...
namespace moment3cdsamling.Controllers
{
    public class AlbumController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AlbumId,Name,Release,ArtistId")] Album album)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AlbumId,Name,Release,ArtistId")] Album album)
        {
            if (id != album.AlbumId)
            {
                return NotFound();
